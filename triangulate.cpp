...
void main(int argc,char **argv)
{
  ...
  a.push_back( b2Vec2(0,6));
  a.push_back( b2Vec2(0,0));
  a.push_back( b2Vec2(3,0));
  a.push_back( b2Vec2(4,1));
  a.push_back( b2Vec2(6,1));
  a.push_back( b2Vec2(8,0));
  a.push_back( b2Vec2(12,0));
  a.push_back( b2Vec2(13,2));
  a.push_back( b2Vec2(8,2));
  a.push_back( b2Vec2(8,4));
  a.push_back( b2Vec2(11,4));
  a.push_back( b2Vec2(11,6));
  a.push_back( b2Vec2(6,6));
  a.push_back( b2Vec2(4,3));
  a.push_back( b2Vec2(2,6));
  ...
  {
    const b2Vec2 &p1 = result[i*3+0];
    const b2Vec2 &p2 = result[i*3+1];
    const b2Vec2 &p3 = result[i*3+2];
